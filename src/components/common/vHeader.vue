<template>
  <header>
    ...
    <div class="no-login">
      <nav class="nav">
        <router-link :to="{ name: 'geneticInterpretation'}" tag="span" :class="{active: $route.name === 'home' || $route.name === 'geneticInterpretation'}">遗传病解读</router-link>
        <span class="query" :class="{active: $route.name === 'diseaseQuery' || $route.name === 'genesQuery' || $route.name === 'variationQuery' || $route.name === 'symptomsQuery'}">查询
          <ul class="query-list">
